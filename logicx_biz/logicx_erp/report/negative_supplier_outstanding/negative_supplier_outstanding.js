(function () {
	frappe.query_reports["Negative Supplier Outstanding"] = {
		...
		formatter: function (value, row, column, data, default_formatter) {
			if (column.fieldname === "open_dashboard") {
				...
				return render_dashboard_button(party);
			}
	...
	// one per-row button in the one HTML cell: "Dashboard" hands the row's
	// party off to the Party Dashboard page.
	function render_dashboard_button(party) {
		return (

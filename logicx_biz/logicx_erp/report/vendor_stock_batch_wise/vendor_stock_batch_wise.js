(function () {
	frappe.query_reports["Vendor Stock Batch-wise"] = {
		...
		filters: [
			{
				...
				label: __("Search"),
				fieldtype: "Data",
				placeholder: __("Vendor | Name | Group | Brand | Batch | Description"),
	...
	const ROUTE = "Vendor Stock Batch-wise";
	...
	const HEADER_WRAP_CLASS = "logicx-wrap-headers-vendor-stock-batch-wise";
	const HEADER_HEIGHT_INCREASE = "15px";
	const FILTER_ROWS_INCREASE = `${1 * 40}px`; // ceiling(filters.COUNT / 6) - 1 = ceiling(8 / 6) - 1 = 1
